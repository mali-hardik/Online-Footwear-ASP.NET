<%@ Page Title="" Language="C#" MasterPageFile="~/User/after_usr.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="User_Default" %>
	...
	<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="discount/slider5.png" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="discount/discount-shoes.jpg" alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="discount/Women_Shoes_slider_S1._V278839832_.jpg" alt="Dummy Image" /></li>
				</ul>

				<!-- Slide Description Image Area (316 x 328) -->
				<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script"><img class="img-responsive" src="discount/Women_Shoes_slider_S1._V278839832__small.jpg" alt="Dummy Image" /></div></li>
						<li><div class="inner-script"><img class="img-responsive" src="discount/slider5_sml_1.png" alt="Dummy Image" /></div></li>
						<li><div class="inner-script"><img class="img-responsive" src="discount/discount-shoes_small.jpg" alt="Dummy Image" /></div></li>
					</ul>
	...
	<div class="col-md-7 content-lgrid">
		<div class="col-sm-6 content-img-left text-center">
			<div class="content-grid-effect slow-zoom vertical">
				<div class="img-box"><img src="images/wo1.jpg" alt="image" class="img-responsive zoom-img"></div>
					<div class="info-box">
		...
		<div class="col-sm-6 content-img-right">
			<h3>Buy 1 get 1  free on <span> Branded</span></h3>
		</div>
		<div class="col-sm-6 content-img-left text-center">
			<div class="content-grid-effect slow-zoom vertical">
				<div class="img-box"><img src="images/wo3.jpg" alt="image" class="img-responsive zoom-img"></div>
					<div class="info-box">
						<div class="info-content simpleCart_shelfItem">
							<h4>CHILDREN</h4>
							<span class="separator"></span>
              ...
              <div class="col-md-3 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								...
								<div class="item-info-product ">
									...
									<%--<a href="addtocart.aspx" class="item_add single-item hvr-outline-out button2">Add to cart</a>--%>
								</div>
							</div>
                       </div>
        </ItemTemplate>
