<%@ Page Title="" Language="C#" MasterPageFile="~/User/men.master" AutoEventWireup="true" CodeFile="children.aspx.cs" Inherits="User_Default" %>
...
<div class="men-wear">
    ...
    <div class="col-md-8 products-right" >
			...
			<div class="men-wear-top">
				...
				<div  id="top" class="callbacks_container">
					<ul class="rslides" id="slider3">
						...
						<li>
							<img class="img-responsive" src="images/woo3.jpg" alt=" "/>
						</li>
					</ul>
				</div>
				<div class="clearfix"></div>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ConnectionString="<%$ ConnectionStrings:constr %>" 
                SelectCommand="SELECT TOP 3 * FROM [product]">
